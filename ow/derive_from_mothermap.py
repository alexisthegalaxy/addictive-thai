...
class Mothermap(object):
    def __init__(self):
        self.daughtermaps = {
            ...
            'phitsalunok': Daughtermap('phitsalunok', x=530, y=545, x2=601, y2=614),
            ...
            'thapkhlo_phitsalunok': Daughtermap('thapkhlo_phitsalunok', x=572, y=596, x2=605, y2=660),
            'chumsaeng': Daughtermap('chumsaeng', x=537, y=660, x2=598, y2=727),
            'khonkaen': Daughtermap('khonkaen', x=897, y=611, x2=951, y2=655),
