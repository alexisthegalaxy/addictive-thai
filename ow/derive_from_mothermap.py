...
class Mothermap(object):
    def __init__(self):
        self.daughtermaps = {
            ...
            'cat_cove_hidden_house': Daughtermap('cat_cove_hidden_house', x=720, y=611, x2=771, y2=639),
            ...
            'kasetsombun': Daughtermap('kasetsombun', x=761, y=635, x2=803, y2=663),
            'kasetsombun_temple': Daughtermap('kasetsombun_temple', x=748, y=624, x2=790, y2=650),
