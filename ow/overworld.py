...
class Mas(object):
    ...
    def form_links(self):
        ...
        self.chaiyaphum_house_2.get_cell_at(10, 13).goes_to = (self.bua_yai, 22, 28)
        ...
        self.chaiyaphum.get_cell_at(37, 90).goes_to = (self.mystery_cave, 9, 11)
        self.mystery_cave.get_cell_at(9, 12).goes_to = (self.chaiyaphum, 37, 91)
        self.mystery_cave.get_cell_at(15, 10).goes_to = (self.ko_kut, 49, 53)
        self.ko_kut.get_cell_at(49, 52).goes_to = (self.mystery_cave, 15, 9)

        # bua yai
        self.bua_yai.get_cell_at(59, 50).goes_to = (self.inn_bua_yai, 4, 7)
        self.inn_bua_yai.get_cell_at(4, 8).goes_to = (self.bua_yai, 59, 51)
        self.bua_yai.get_cell_at(78, 51).goes_to = (self.phon, 8, 106)
        self.bua_yai.get_cell_at(78, 52).goes_to = (self.phon, 8, 107)
        self.phon.get_cell_at(7, 106).goes_to = (self.bua_yai, 77, 51)
        self.phon.get_cell_at(7, 107).goes_to = (self.bua_yai, 77, 52)

        # phon
        self.phon.get_cell_at(58, 7).goes_to = (self.khonkaen, 26, 40)
        self.phon.get_cell_at(59, 7).goes_to = (self.khonkaen, 27, 40)
        self.khonkaen.get_cell_at(26, 41).goes_to = (self.phon, 58, 8)
        self.khonkaen.get_cell_at(27, 41).goes_to = (self.phon, 59, 8)
        ...
        self.labyrinth.get_cell_at(7, 16).goes_to = (self.phitsanulok, 63, 16)
        self.labyrinth.get_cell_at(8, 16).goes_to = (self.phitsanulok, 64, 16)
        self.phitsanulok.get_cell_at(63, 15).goes_to = (self.labyrinth, 7, 15)
        self.phitsanulok.get_cell_at(64, 15).goes_to = (self.labyrinth, 8, 15)
