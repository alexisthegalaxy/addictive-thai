...
def npc_sprites():
    ...
    return {
        ...
        "black_byspell": pygame.image.load(f"{dir_path}/../npc/sprites/black_byspell.png"),
        "white_byspell": pygame.image.load(f"{dir_path}/../npc/sprites/white_byspell.png"),
        "red_byspell": pygame.image.load(f"{dir_path}/../npc/sprites/red_byspell.png"),
        "green_byspell": pygame.image.load(f"{dir_path}/../npc/sprites/green_byspell.png"),
        "grey_byspell": pygame.image.load(f"{dir_path}/../npc/sprites/grey_byspell.png"),
