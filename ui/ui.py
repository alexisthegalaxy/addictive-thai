...
def npc_sprites():
    ...
    return {
        ...
        "leopard_gecko_down": pygame.image.load(f"{dir_path}/../npc/sprites/leopard_gecko_down.png"),
        "leopard_gecko_up": pygame.image.load(f"{dir_path}/../npc/sprites/leopard_gecko_up.png"),
        "leopard_gecko_right": pygame.image.load(f"{dir_path}/../npc/sprites/leopard_gecko_right.png"),
        "leopard_gecko_left": pygame.image.load(f"{dir_path}/../npc/sprites/leopard_gecko_left.png"),
