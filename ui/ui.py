...
class Ui(object):
    def __init__(self):
        ...
        self.fonts = Fonts()
        self.sprites = {
            "grass": pygame.image.load(f"{dir_path}/../ow/sprites/grass.bmp"),
            "path": pygame.image.load(f"{dir_path}/../ow/sprites/path.bmp"),
            "tree": pygame.image.load(f"{dir_path}/../ow/sprites/tree.bmp"),
            "waterfall": pygame.image.load(f"{dir_path}/../ow/sprites/waterfall1.bmp"),
            ...
            "flower": pygame.image.load(f"{dir_path}/../ow/sprites/flower.bmp"),
            "flower_2": pygame.image.load(f"{dir_path}/../ow/sprites/flower_2.bmp"),
            ...
            "tall_grass": pygame.image.load(f"{dir_path}/../ow/sprites/tall_grass.bmp"),
