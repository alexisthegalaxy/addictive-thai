...
def npc_sprites():
    ...
    return {
        ...
        "spell_black": pygame.image.load(f"{dir_path}/../npc/sprites/spell_black.png"),
        "spell_white": pygame.image.load(f"{dir_path}/../npc/sprites/spell_white.png"),
        "spell_red": pygame.image.load(f"{dir_path}/../npc/sprites/spell_red.png"),
        "spell_green": pygame.image.load(f"{dir_path}/../npc/sprites/spell_green.png"),
        "spell_grey": pygame.image.load(f"{dir_path}/../npc/sprites/spell_grey.png"),
        "spell_yellow": pygame.image.load(f"{dir_path}/../npc/sprites/spell_yellow.png"),
        "spell_purple": pygame.image.load(f"{dir_path}/../npc/sprites/spell_purple.png"),
        "spell_teal": pygame.image.load(f"{dir_path}/../npc/sprites/spell_teal.png"),
        "spell_blue": pygame.image.load(f"{dir_path}/../npc/sprites/spell_blue.png"),
...
def random_images():
    return {
        ...
        "tone_rising": pygame.image.load(f"{dir_path}/../images/tone_rising.png"),
        "tone_mid": pygame.image.load(f"{dir_path}/../images/tone_mid.png"),
        "tone_low": pygame.image.load(f"{dir_path}/../images/tone_low.png"),
        "tone_falling": pygame.image.load(f"{dir_path}/../images/tone_falling.png"),
        "tone_high": pygame.image.load(f"{dir_path}/../images/tone_high.png"),
