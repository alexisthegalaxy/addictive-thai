...
class Keyboard(object):
    def __init__(self, ui, x=None, y=None):
        self.x = ui.percent_width(0.22) if x is None else x
        self.y = ui.percent_height(0.52) if y is None else y
