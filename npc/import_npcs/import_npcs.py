...
def lomsak(al):
    npcs = [
        Npc(
            ...
            direction=Direction.DOWN,
            standard_dialog=[
                "It all comes from the Pali word, \"bhāsā\" or the Sanskrit word {saभाषा{en (\"{sabhāṣā{en\").",
                "I teach languages at Lomsak school.",
                "You wanna learn the word for language?",
            ],
            defeat_dialog=[
                "Thailand is surrounded by four countries.",
                "In Lao, language is {lo ພາສາ {en (\"phasa\").",
                "In Myanmar, language is {my ဘာသာ {en(\"bhasa\").",
                "In Cambodia, language is {kh ភាសា {en (\"pheasaea\").",
                "And in Malaysia, language is bahasa.",
                "It all comes from the Pali word, \"bhāsā\" or the Sanskrit word {saभाषा{en (\"{sabhāṣā{en\").",
                "Also, do you see how these languages all similarly write the \"ā\" sound?",
                "{th ภา-ษา {lo ພາສາ {my ဘာသာ {kh ភាសា {sa भाषा {en they all kinda look like a า!",
                "Also, don't you agree that {lo ພາສາ {en looks like พาสา?",
                "Aaah, I love languages...",
            ],
        ),
        Npc(
            al=al,
