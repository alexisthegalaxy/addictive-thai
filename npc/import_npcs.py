    ...
    npcs = [
        Npc(
            ...
            standard_dialog=[
                ...
                # "As you know, each word is a spell with its own powers - but first, let's learn the alphabet.",
        ...
        Npc(
            ...
            y=55,
            standard_dialog=[
                "Nim: oh, you see that letter? It's the m!",
            ],
            defeat_dialog=[
...
"""
    taught=Word.get_by_split_form("โรง"),
"""
